...
describe('workspace UI state', () => {
  beforeEach(() => useUiStore.setState({ outlineOpen: true, inspectorOpen: true, validationOpen: false, paletteOpen: false, shortcutsOpen: false, cardDensity: 'auto', canvasZoom: 1, edgeKind: 'affects', connectionSourceId: undefined, selectedRelationId: undefined }));
