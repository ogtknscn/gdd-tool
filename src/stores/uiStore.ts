...
type UiState = {
  outlineOpen: boolean; inspectorOpen: boolean; validationOpen: boolean; paletteOpen: boolean; shortcutsOpen: boolean; playgroundOpen: boolean; markdownPreviewOpen: boolean; readinessView: boolean;
  ...
  toggleOutline: () => void; toggleInspector: () => void; toggleValidation: () => void; togglePlayground: () => void; toggleMarkdownPreview: () => void; toggleReadinessView: () => void;
...
export const useUiStore = create<UiState>((set) => ({
  outlineOpen: true, inspectorOpen: true, validationOpen: false, paletteOpen: false, shortcutsOpen: false, playgroundOpen: false, markdownPreviewOpen: false, readinessView: false,
  cardDensity: 'auto', canvasZoom: 1, edgeKind: 'affects', nodeFilter: { query: '', kinds: [], statuses: [], tags: [], focusMode: false, filterOpen: false },
  toggleOutline: () => set((state) => ({ outlineOpen: !state.outlineOpen })), toggleInspector: () => set((state) => ({ inspectorOpen: !state.inspectorOpen })), toggleValidation: () => set((state) => ({ validationOpen: !state.validationOpen })), togglePlayground: () => set((state) => ({ playgroundOpen: !state.playgroundOpen })), toggleMarkdownPreview: () => set((state) => ({ markdownPreviewOpen: !state.markdownPreviewOpen })), toggleReadinessView: () => set((state) => ({ readinessView: !state.readinessView })),
