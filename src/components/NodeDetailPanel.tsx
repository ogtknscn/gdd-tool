...
export function NodeDetailPanel() {
  ...
  const closeDetail = useProjectStore((state) => state.closeDetail); const updateNode = useProjectStore((state) => state.updateNode); const updateRelation = useProjectStore((state) => state.updateRelation); const openDetail = useProjectStore((state) => state.openDetail);
